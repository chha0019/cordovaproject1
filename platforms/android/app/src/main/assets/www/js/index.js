...
var APP = (function () {
    ...
    function init() {
        document.getElementById('add').addEventListener('click', nav);
        document.getElementById('save').addEventListener('click', nav);
        document.getElementById('cancel').addEventListener('click', nav);
        document.getElementById('back').addEventListener('click', nav);
        document.getElementById('delete').addEventListener('click', nav);
